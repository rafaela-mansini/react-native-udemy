        ...
        >
            <View style={styles.frame}>
                <View style={styles.title}>
                    <TouchableOpacity style={[styles.button, styles.bgVeryEasy]} onPress={() => onLevelSelected(0.05)}>
                        <Text style={styles.buttonLabel}>Very Easy</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={[styles.button, styles.bgVeryHard]} onPress={() => onLevelSelected(0.5)}>
